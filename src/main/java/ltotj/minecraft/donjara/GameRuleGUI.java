...
public class GameRuleGUI {
    ...
    GameRuleGUI(){
        ...
        mainGUI.setItem(18,tileList.getYakuMaterial(9),"§l§5役：さらなる深みへ","§l§630000点","§eクリックで詳細を表示");
        ...
        mainGUI.setItem(24,Material.PLAYER_HEAD,"§l§d役：親孝行","§l§6×1.5倍","§9親がアガると成立");
        mainGUI.setItem(25,Material.PLAYER_HEAD,"§l§d役：親不孝","§l§6×1.5倍","§9親にロンすることで成立");
        ...
        setExample(9,new int[]{34,35,36,66,67,68,86,87,88},"§l§5役：さらなる深みへ","§l§630000点","§9ネザーに現れるブロック・MOBを全て揃えることで成立","§9オールマイティ：§e有効");
        setExample(10,new int[]{0,1,8,40,41,44,80,85,87},"§l§d役：モンスターハント","§l§67000点","§9剣、防具、スポーンエッグをそれぞれ１セット以上揃えることで成立","§9オールマイティ：§e有効");
